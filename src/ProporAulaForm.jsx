                ...
                for (const labGroup of formData.dynamicLabs) {
                    for (const labName of labGroup.laboratorios) {
                        aulasParaAgendar.push({
                            ...
                            professorUid: userInfo?.uid || currentUser?.uid || userInfo?.email || currentUser?.email,
                            professorNome: userInfo?.name || currentUser?.displayName || currentUser?.email || 'Técnico',
                            propostoPorUid: userInfo?.uid || currentUser?.uid || userInfo?.email || currentUser?.email,
                            propostoPorNome: userInfo?.name || currentUser?.displayName || currentUser?.email || 'Técnico',
