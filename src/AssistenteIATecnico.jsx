...
const VALID_GROQ_MODELS = ['llama-3.3-70b-versatile', 'llama-3.1-8b-instant', 'llama3-70b-8192', 'llama3-8b-8192', 'mixtral-8x7b-32768', 'gemma2-9b-it'];
const RAW_MODEL = import.meta.env.VITE_GROQ_MODEL_LIGHT;
const GROQ_MODEL = (RAW_MODEL && VALID_GROQ_MODELS.includes(RAW_MODEL) && RAW_MODEL !== 'llama-3.1-70b-versatile') ? RAW_MODEL : 'llama-3.1-8b-instant';
